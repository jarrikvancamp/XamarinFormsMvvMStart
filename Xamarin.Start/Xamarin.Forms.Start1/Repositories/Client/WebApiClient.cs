...
using Xamarin.Forms.Start1.Repositories.ContentResolvers;
using Xamarin.Forms.Start1.Repositories.Extensions;
using Xamarin.Forms.Start1.Repositories.ResponseResolvers;

namespace Xamarin.Forms.Start1.Repositories.Client {
